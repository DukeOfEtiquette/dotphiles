# Debian Upgrade Checklists

This document consolidates upgrade checklists for major Debian version upgrades.

## Navigation

- [Bullseye to Bookworm](#debian-12-bookworm-upgrade-checklist) (Debian 11 → 12)
- [Bookworm to Trixie](#debian-13-trixie-upgrade-checklist) (Debian 12 → 13)
...
2. Proceed to the Trixie upgrade section below
...
**Prerequisite**: Complete the Bookworm upgrade above first and verify system stability.
